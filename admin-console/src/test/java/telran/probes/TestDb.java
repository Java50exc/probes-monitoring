...
public class TestDb {
	...
	static final SensorUpdateData SENSOR_UPDATE_RANGE_DATA = new SensorUpdateData(SENSOR_RANGE_UPDATED.id(), SENSOR_RANGE_UPDATED.range(), null);
	static final SensorUpdateData SENSOR_UPDATE_EMAILS_DATA = new SensorUpdateData(SENSOR_EMAILS_UPDATED.id(), null, SENSOR_EMAILS_UPDATED.mails());
